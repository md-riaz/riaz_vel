            ...
            <div class="row">
                <div class="col-12">
                        ...
                        <table class="table-responsive cart-wrap">
                            ...
                            @forelse($cart as $item)
                                <tr>
                                    ...
                                    <td class="product"><a
                                            href="{{url('product/'.$item->product->id)}}">{{$item->product->product_name}}
                                            (Aval Q. {{$item->product->product_quantity}})</a>

                                        @if($item->product->product_quantity < $item->quantity)
                                            <p class="text-danger">You have to remove or decrease this product
                                                quantity</p>
                                            @php
                                                $err++
                                            @endphp
                    ...
                    <div class="cupon-wrap">
                        <input type="text" placeholder="Cupon Code" id="couponinput" value="{{$coupon_name ?? ""}}">
                        <a id="applyCoupon"
                           style="width: 150px;
                              height: 45px;
                              position: absolute;
                              ...
                              border: none;text-align: center;line-height: 3.3;cursor: pointer">Apply Cupon</a>
                    </div>
                </div>
                @if(session('invalid'))
            ...
            <div class="col-xl-3 offset-xl-5 col-lg-4 offset-lg-3 col-md-6">
                <div class="cart-total text-right">
                    ...
                    <ul>
                        ...
                        @isset($discount)
                            <li><span class="pull-left">Discount({{$discount}}%) </span> - BDT.
