        ...
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form method="post" action="{{ url('store/banner')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="banner_photo">Banner Image</label>
                        <input type="file" class="form-control-file" id="banner_photo" name="banner_photo">
                        @error('banner_photo')
                        <div class="alert alert-warning" role="alert">
                            {{$message}}
                        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom-primary">
                                ...
                                <td>{{Str::limit($banner->banner_info, 25)}}</td>
                                <td><img src="{{asset('uploads/banner_photos/'.$banner->banner_photo)}}" alt="Not found"
