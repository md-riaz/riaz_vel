            ...
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h2 class="big">Deal Of the Day <span>Contrary to popular belief, Lorem Ipsum is not simply random
                            text. It has roots in a piece of classical Latin</span>
                    </h2>
                </div>
                <div class="col-12 col-lg-12 text-center">
            ...
            <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                <div class="product-wrap">
                    <div class="product-img">
                        <img src="{{ asset('uploads/product_photos/'.$best_sell->product->product_thumbnail_photo) }}"
                            alt="">
                    ...
                    <div class="product-content">
                        <h3>
                            <a
                                href="{{url('product/'.$best_sell->product->id)}}">{{$best_sell->product->product_name}}</a>
                        </h3>
                        ...
                        <div class="product-icon flex-style">
                            <ul>
                                <li><a data-toggle="modal" data-target="#product_id_{{$product->id}}"
                                        href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                <li><a href="{{url('add/to/wishlist/'.$product->id)}}"><i class="fa fa-heart"></i></a>
                                </li>
                                <li><a href="{{url('cart')}}"><i class="fa fa-shopping-bag"></i></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="test-items test-items2">
                        ...
                        <div class="test-img2">
                            <img src="{{ asset('uploads/testimonial_photos/'.$testimonial->client_photo) }}"
                                style="width: 140px;height: 130px;border-radius: 50%;" alt="">
                        </div>
                    </div>
                    @empty
