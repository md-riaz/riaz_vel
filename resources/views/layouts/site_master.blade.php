                        ...
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{ asset('uploads/product_photos/'.$wishlist->product->product_thumbnail_photo) }}"
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{ asset('uploads/product_photos/'.$cart->product->product_thumbnail_photo) }}"
                                                alt="Product Photo" width="80">
                                        </div>
                                        <div class="cart-content">
                                            <a
